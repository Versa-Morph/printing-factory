        ...
        <div class="card">
            ...
            <div class="card-body">
                <form class="form-data">
                    ...
                    <a href="{{ route('sales-task-management-list') }}" class="btn btn-danger" style="float: left">Kembali</a>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            form.addEventListener('submit', function(e) {
                ...
                if (isValid) {
                    ...
                    $.ajax({
                        url: '{{ route('sales-task-management-store') }}',
                        type: 'POST',
                        data: formData,
                        processData: false,
                        contentType: false,
                        ...
                        success: function(response) {
                            if (response.success) {
                                ...
                                window.location.href = '{{ route('sales-task-management-list') }}';
                            } else {
