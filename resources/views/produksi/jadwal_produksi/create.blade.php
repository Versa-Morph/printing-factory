                    ...
                    <div class="row">
                                ...
                                <select name="id_rencana" class="form-control select2" id="id_rencana">
                                    ...
                                    @foreach ($rencana as $item)
                                        <option value="{{ $item->id }}">
                                            {{ $item->desain->nama_desain . ' | ' . $item->jumlah_produksi . ' Produksi' . ' | ' . $item->tanggal_mulai . ' - ' . $item->tanggal_selesai }}
                                        </option>
                                    @endforeach
                                </select>
                            </div>
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input type="date" class="form-control" value="" name="tanggal_produksi">
                            </div>
                        </div><!-- end col -->
    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            form.addEventListener('submit', function(e) {
                ...
                const tanggal_produksi = document.querySelector('input[name="tanggal_produksi"]').value
                    .trim();
                let isValid = true;
                ...
                if (isValid) {
                    ...
                    $.ajax({
                        url: '{{ route('jadwal-produksi-store') }}',
                        type: 'POST',
                        data: formData,
                        processData: false,
                        contentType: false,
