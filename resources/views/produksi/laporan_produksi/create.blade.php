                            ...
                            <div class="mb-3">
                                ...
                                <select name="id_jadwal" class="form-control select2" id="id_jadwal">
                                    ...
                                    @foreach ($jadwal as $item)
                                        <option value="{{ $item->id }}">{{ $item->rencana->desain->nama_desain .' | '. $item->rencana->jumlah_produksi .' Produksi' .' | Tanggal : '.$item->tanggal_produksi}}</option>
                                    @endforeach
                                </select>
                            </div>
                        </div><!-- end col -->
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input type="number" class="form-control" name="jumlah_reject">
                            </div>
                        </div><!-- end col -->
                        <div class="col-md-6">
                            <div class="mb-3">
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            form.addEventListener('submit', function(e) {
                ...
                if (isValid) {
                    ...
                    $.ajax({
                        url: '{{ route('laporan-produksi-store') }}',
                        type: 'POST',
                        data: formData,
                        processData: false,
                        contentType: false,
