                    ...
                    <div class="row">
                        <div class="col-md-4">
                            <div class="mb-3" style="text-align: left">
                                <label class="form-label">Desain Produk</label>
                                <select class="form-select form-select-sm mr-sm-2 @error('id_desain') is-invalid @enderror" id="id_desain" name="id_desain" style="width:100%">
                                    <option disabled selected>Choose Design</option>
                                    @foreach ($desain_products as $desain_product)
                                    <option value="{{ $desain_product->id }}"
                                        {{ old('id_desain_product', $rencana_produksi->id_desain) == $desain_product->id ? 'selected' : '' }}>
                                        {{ $desain_product->nama_desain }} 
                                    </option>
                                    @endforeach
                                </select>
                            </div>
                        ...
                        <div class="col-md-4">
                            <div class="mb-3">
                                ...
                                <input type="number" class="form-control" value="{{ $rencana_produksi->jumlah_produksi }}" name="jumlah_produksi" placeholder="Ex:10..">
                            </div>
                        </div><!-- end col -->
                        ...
                        <div class="col-md-4">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" value="{{ $rencana_produksi->jabatan }}" name="jabatan" placeholder="Ex:Supervisor">
                            </div>
                        </div><!-- end col -->
                        ...
                        <div class="col-md-4">
                            <div class="mb-3">
                                ...
                                <input type="date" class="form-control" value="{{ $rencana_produksi->tanggal_mulai }}" name="tanggal_mulai">
                            </div>
                        </div><!-- end col -->
                        ...
                        <div class="col-md-4">
                            <div class="mb-3">
                                ...
                                <input type="date" class="form-control" value="{{ $rencana_produksi->tanggal_selesai }}" name="tanggal_selesai">
                            </div>
                        </div><!-- end col -->
                        ...
                        <div class="col-md-4 mb-4">
                            ...
                            <select class="form-select" name="status_rencana">
                                <option value="Aktif" {{ $rencana_produksi->status == 'Aktif' ? 'selected' : '' }}>Aktif</option>
                                <option value="Selesai" {{ $rencana_produksi->status == 'Selesai' ? 'selected' : '' }}>Selesai</option>
                            </select>
                        </div>
                    </div><!-- end row -->
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            form.addEventListener('submit', function(e) {
                ...
                if (isValid) {
                    ...
                    $.ajax({
                        url: '{{ route('rencana-produksi-update',$rencana_produksi->id) }}',
                        type: 'POST',
                        data: formData,
                        processData: false,
                        contentType: false,
