    ...
    <div class="card-body">
        <div class="row align-items-end">
            <div class="col-sm">
                ...
                <div>
                    <a href="{{ route('status-attendance-create') }}" class="btn btn-light mb-4 bg-primary text-white" style="float: right"><i class="mdi mdi-plus me-1"></i> Tambah Status Attendance</a>
                </div>
                @endcan
            </div>
        </div>
                ...
                $.ajax({
                    ...
                    success: function (response) {
                        if (response.success) {
                            ...
                            $('#status-attendance-table').DataTable().ajax.reload();
                        } else {
                            Swal.fire(
                                'Error!',
                                response.error,
