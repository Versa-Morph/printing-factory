                            ...
                            <div class="row">
                                    ...
                                    <div class="mb-3"style="text-align: left">
                                        ...
                                        <select class="form-select mr-sm-2 @error('quotation') is-invalid @enderror" id="quotation" name="quotation" style="width:100%">
                                            ...
                                            <option value="{{ $quotation->id }}"
                                                {{ old('quotation_number', $order->quotation_number) == $quotation->quotation_number ? 'selected' : '' }}>
                                ...
                                <div class="col-lg-6">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control" value="{{ $order->order_number }}" name="order_number" placeholder="Ex:QT001..">
                                    </div>
                                </div>
                            </div><!-- end row -->
                        </div>
                            ...
                            <div class="row mt-2">
                                <div class="col-md-4">
                                    <div class="mb-3">
                                        ...
                                        <input readonly type="text" class="form-control" value="{{ $order->quotation_number }}" name="quotation_number" placeholder="Ex:QT001..">
                                    </div>
                                </div><!-- end col -->
                                ...
                                <div class="col-md-4">
                                    <div class="mb-3">
                                        ...
                                        <input readonly type="text" class="form-control" value="{{ $order->po_number }}" name="po_number" placeholder="Ex:PO001">
                                    </div>
                                </div><!-- end col -->
                                ...
                                <div class="col-md-4">
                                    <div class="mb-3">
                                        ...
                                        <input readonly type="text" class="form-control" value="{{ $order->company_code }}" name="company_code" placeholder="Ex:..">
                                    </div>
                                </div><!-- end col -->
                                ...
                                <div class="col-md-4">
                                    <div class="mb-3">
                                        ...
                                        <input readonly type="number" class="form-control" value="{{ $order->reduction }}" name="reduction" placeholder="Ex:10">
                                    </div>
                                </div><!-- end col -->
                                ...
                                <div class="col-md-4">
                                    <div class="mb-3">
                                        ...
                                        <input readonly type="text" class="form-control "value="{{ $order->position }}" name="position" placeholder="Ex:Potrait">
                                    </div>
                                </div><!-- end col -->
                                ...
                                <div class="col-md-4">
                                    <div class="mb-3">
                                        ...
                                        <input readonly type="number" class="form-control" value="{{ $order->discount_percent }}" name="discount_percent" placeholder="Ex:10 %">
                                    </div>
                                </div><!-- end col -->
                                ...
                                <div class="col-md-4">
                                    <div class="mb-3">
                                        ...
                                        <input readonly type="number" class="form-control" value="{{ $order->discount_price }}" name="price" placeholder="Ex:100.000">
                                    </div>
                                </div><!-- end col -->
                            ...
                            <div class="row mt-2">
                                ...
                                <div class="col-md-4">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control" value="{{ $order->job_no }}" name="job_no" placeholder="Ex:">
                                    </div>
                                </div><!-- end col -->
                                ...
                                <div class="col-md-4">
                                    <div class="mb-3">
                                        ...
                                        <input type="datetime-local" class="form-control" value="{{ $order->delivery_datetime }}" name="delivery_datetime" placeholder="Ex:">
                                    </div>
                                </div><!-- end col -->
                                ...
                                <div class="col-md-4">
                                    <div class="mb-3">
                                        ...
                                        <input type="datetime-local" class="form-control" value="{{ $order->received_datetime }}" name="received_datetime" placeholder="Ex:">
                                    </div>
                                </div><!-- end col -->
                                ...
                                <div class="col-md-4">
                                    <div class="mb-3">
                                        ...
                                        <input type="datetime-local" class="form-control" value="{{ $order->designer_start_datetime }}" name="designer_start_datetime" placeholder="Ex:">
                                    </div>
                                </div><!-- end col -->
                                ...
                                <div class="col-md-4">
                                    <div class="mb-3">
                                        ...
                                        <input type="datetime-local" class="form-control" value="{{ $order->designer_end_datetime }}" name="designer_end_datetime" placeholder="Ex:">
                                    </div>
                                </div><!-- end col -->
                                ...
                                <div class="col-md-4">
                                    <div class="mb-3">
                                        ...
                                        <input type="datetime-local" class="form-control" value="{{ $order->operator_start_datetime }}" name="operator_start_datetime" placeholder="Ex:">
                                    </div>
                                </div><!-- end col -->
                                ...
                                <div class="col-md-4">
                                    <div class="mb-3">
                                        ...
                                        <input type="datetime-local" class="form-control" value="{{ $order->operator_end_datetime }}" name="operator_end_datetime" placeholder="Ex:">
                                    </div>
                                </div><!-- end col -->
                            </div>
                        </div>
                                ...
                                <div class="col-lg-12">
                                    <div class="table-responsive">
                                        <table class="table table-hover" id="orderRemarksTable">
                                            ...
                                            <tbody>
                                                @foreach ($order->orderRemark ?? [] as $key => $order_remark)
                                                <tr>
                                                    <td>
                                ...
                                <div class="col-lg-12">
                                    <div class="table-responsive">
                                        <table class="table table-hover" id="orderColorsTable">
                                            ...
                                            <tbody>
                                                @foreach ($order->orderColor ?? [] as $key => $order_color)
                                                <tr>
                                                    <td>
                                ...
                                <div class="col-lg-12">
                                    <div class="table-responsive">
                                        <table class="table table-hover" id="orderSizesTable">
                                            ...
                                            <tbody>
                                                @foreach ($order->orderSize ?? [] as $key => $order_size)
                                                <tr>
                                                    <td>
                                                        <input type="number" class="form-control" value="{{ $order_size->size1 }}" name="size1[]" placeholder="Ex:">
                                                    </td>
                                                    <td>
                                                        <input type="number" class="form-control" value="{{ $order_size->size2 }}" name="size2[]" placeholder="Ex:">
                                                    </td>
