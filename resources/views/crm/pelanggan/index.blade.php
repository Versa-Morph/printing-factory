    ...
    <div class="card-body">
        <div class="row align-items-start">
            <div class="col-sm">
                ...
                <div>
                    <a href="{{ route('pelanggan-create') }}" class="btn btn-light mb-4"><i class="mdi mdi-plus me-1"></i> Tambah Pelanggan</a>
                </div>
                @endcan
            </div>
        </div>
        ...
        <div class="table-responsive mt-4 mt-sm-0">
            <table class="table align-middle table-nowrap table-check" id="pelanggan-table">
                <thead>
