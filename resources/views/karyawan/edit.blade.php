                    ...
                    <div class="row">
                        <div class="col-md-4">
                            <div class="mb-3"style="text-align: left">
                                ...
                                <select class="form-select form-select-sm mr-sm-2 @error('user_id') is-invalid @enderror" id="user_id" name="user_id" style="width:100%">
                        ...
                        <div class="col-md-4">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" value="{{ $karyawan->nama_karyawan }}" name="nama_karyawan" placeholder="Ex:David..">
                            </div>
                        </div><!-- end col -->
                        ...
                        <div class="col-md-4">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" value="{{ $karyawan->jabatan }}" name="jabatan" placeholder="Ex:Supervisor">
                            </div>
                        </div><!-- end col -->
                        ...
                        <div class="col-md-4">
                            <div class="mb-3">
                                ...
                                <input type="number" class="form-control"value="{{ $karyawan->gaji }}" name="gaji" placeholder="Ex:4.000.000">
                            </div>
                        </div><!-- end col -->
                        ...
                        <div class="col-md-4">
                            <div class="mb-3">
                                ...
                                <input type="email" class="form-control" value="{{ $karyawan->email }}" name="email" placeholder="Ex:xxxx@gmail.com">
                            </div>
                        </div><!-- end col -->
                        ...
                        <div class="col-md-4">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" value="{{ $karyawan->no_telepon }}" name="no_telepon" placeholder="Ex:08xxxxxxx">
                            </div>
                        </div><!-- end col -->
                        ...
                        <div class="col-md-4">
                            <div class="mb-3">
                                ...
                                <textarea name="alamat" class="form-control" placeholder="Ex:Jakarta...">{{ $karyawan->alamat }}</textarea>
                            </div>
                        </div><!-- end col -->
                        ...
                        <div class="col-md-4">
                            <div class="mb-3">
                                ...
                                <input type="date" class="form-control" value="{{ $karyawan->tanggal_masuk }}" name="tanggal_masuk">
                            </div>
                        </div><!-- end col -->
