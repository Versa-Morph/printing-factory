            ...
            <div class="container">
                ...
                @else
                    <div class="categories-wrap mt-32">
                        <a href="{{ isset($cekAttendance) && $cekAttendance->clock_in != null ? '#' : route('pwa-attend').'?type=clock-in' }}">
                        ...
                        <a href="{{ isset($cekAttendance) && $cekAttendance->clock_out != null ? '#' : route('pwa-attend').'?type=clock-out' }}">
                            <div class="categories-content shadow-sm rounded-2 card-content">
                                <div>
                                    <center>
                        ...
                        <a href="{{ isset($cekAttendance) && $cekAttendance->break_start != null ? '#' : route('pwa-attend').'?type=break' }}">
                            <div class="categories-content shadow-sm rounded-2 card-content">
                                <div>
                                    <center>
                        ...
                        <a href="{{ isset($cekAttendance) && $cekAttendance->break_end != null ? '#' : route('pwa-attend').'?type=after-break' }}">
                            <div class="categories-content shadow-sm rounded-2 card-content">
                                <div>
                                    <center>
                                        <img src="{{ asset('assets-pwa/images/icons/break-time.png') }}"
                        ...
                        <a href="{{ isset($cekAttendance) && $cekAttendance->overtime_in != null ? '#' : route('pwa-attend').'?type=overtime-in' }}">
                            <div class="categories-content shadow-sm rounded-2 card-content">
                                <div>
                                    <center>
                        ...
                        <a href="{{ isset($cekAttendance) && $cekAttendance->overtime_out != null ? '#' : route('pwa-attend').'?type=overtime-out' }}">
                            <div class="categories-content shadow-sm rounded-2 card-content">
                                <div>
                                    <center>
                                        <img src="{{ asset('assets-pwa/images/icons/overtime.png') }}"
