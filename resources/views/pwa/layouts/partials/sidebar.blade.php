            ...
            <div class="dropdown">
                <div class="setting-page-full">
                    <div class="setting-page-wrapper">
                        <div class="setting-deatils mb-2 p-3"
                            style="background-color: #f1f1f1; border-radius:20px 20px 0 0;">
                            <img src="{{ asset('assets/logo-polimer.png') }}" class="d-block mx-auto"
                                style="max-width: 50%;" alt="category-img" />
                        </div>
                        <a href="{{ route('pwa-homepage') }}" class="mt-8">
                            <div class="setting-deatils">
                                <div class="setting-icon">
                                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                                        xmlns="http://www.w3.org/2000/svg">
                                        <mask id="mask0_231_1105" style="mask-type:alpha" maskUnits="userSpaceOnUse"
                                        ...
                                        <g mask="url(#mask0_231_1105)">
                                            ...
                                            <path d="M7 12H21L18 9M18 15L21 12" stroke="#F97316" stroke-width="2"
                        ...
                        <a href="{{ route('pwa-overtime-list') }}" class="mt-8">
                            <div class="setting-deatils">
                                <div class="setting-icon">
                                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                                        xmlns="http://www.w3.org/2000/svg">
                        ...
                        <a href="{{ route('pwa-absence-list') }}" class="mt-8">
                            <div class="setting-deatils">
                                <div class="setting-icon">
                                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                                        xmlns="http://www.w3.org/2000/svg">
